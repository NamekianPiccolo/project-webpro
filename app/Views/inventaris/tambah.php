...
<div class="container-fluid py-4">
    <div class="card tambah-card p-4">
        <div class="d-flex align-items-center mb-4">
            ...
            <h4 class="fw-bold m-0 text-dark">Tambah Alat Baru</h4>
        </div>
                ...
                <div class="col-lg-7">
                    <div class="p-3 bg-light rounded-4 border-0">
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_alat" class="form-control shadow-sm" value="" placeholder="Masukkan nama alat..." required>
                        </div>

                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label-custom">Jumlah (Stok)</label>
                                <input type="number" name="jumlah" class="form-control shadow-sm" min="1" value="1" required>
                            </div>
                            <div class="col-md-4 mb-3">
