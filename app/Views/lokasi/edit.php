...
<div class="card shadow-sm border-0 rounded-4 p-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <h4 class="fw-bold m-0">Edit Lokasi Penyimpanan</h4>
    </div>
    
    <form action="<?= base_url('lokasi/update/' . $lokasi_data['id']) ?>" method="post">
        <?= csrf_field() ?>
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-4">
                ...
                <textarea class="form-control shadow-sm" name="keterangan" rows="3" 
                          placeholder="Jelaskan detail posisi penyimpanan barang..."><?= $lokasi_data['keterangan'] ?></textarea>
            </div>
        </div>
